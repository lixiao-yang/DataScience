...
(define (all_q? L)
  (cond
    ...
    [else (all_q? (rest L))])); replace this null here with the lines of your code
...
(define (at_least_one_q? L)
  (cond
    [(null? L) #f]
    [(equal? (first L) 'q) #t]
    [else (at_least_one_q? (rest L))])); replace this null here with the lines of your code
...
(define (exactly_one_q? L)
  (cond
    ...
    [else (exactly_one_q? (rest L))])); replace this null here with the lines of your code
...
(define (odd_amt_q? L)
  (cond
    ...
    [else (odd_amt_q? (rest L))])); replace this null here with the lines of your code
...
(define (odd_amt_q_nonrec L)
  (foldr (lambda (m n)
           (if (equal? m n) #f #t))
           #f
           (map (lambda (x) (equal? x 'q)) L))); replace this null here with the lines of your code
...
(define (sub M N)
  (cond
    [(pzero? N) M]
    [(pzero? M) zero]
    [else (sub (pred M) (pred N))])); replace this null here with the lines of your code
...
(define (div M N)
  (cond
    [(pzero? M) zero]
    [(ltpnum? M N) zero]
    [else (succ (div (sub M N) N))])); replace this null here with the lines of your code
...
(define (rem M N)
  (cond
    [(pzero? M) zero]
    [(ltpnum? M N) M]
    [else (rem (sub M N) N)])); replace this null here with the lines of your code
...
(define (dubplus X Y)
  (cond
    [(dubzero? X) Y]
    [(dubzero? Y) X]
    [(and (double? X) (double? Y)) (double (dubplus (op X) (op Y)))]
    [(and (double-plus1? X) (double-plus1? Y)) (double (inc (dubplus (op X) (op Y))))]
    [else (double-plus1 (dubplus (op X) (op Y)))])); replace this null here with the lines of your code
...
(define (dubmult X Y)
  (cond
    [(or (dubzero? X) (dubzero? Y))dubzero]
    [(double? Y) (double (dubmult X (op Y)))]
    [else (dubplus (double (dubmult X (op Y))) X)])); replace this null here with the lines of your code
